    ...
    let temp_html = `<div id='photo_title' style="float:left; margin-bottom:5px;">${title}</div> 
                    ...
                    <div style="display: flex; align-items: center;">
                        ...
                        <input name="comment" id="comment" type="textarea" class="form-control" placeholder="comment">
                            <button type="button" id="commentBtn" value="${photo_id}" onclick="addComment()" class="btn btn-secondary" data-bs-dismiss="modal" 
                            style="height: 37px; background-color:  #7689b1; border-color: #7689b1;"><b>+</b></button>
                    </div>
                    <hr/>
                    <div>
                    <style>
                    ...
                    ${comments.map(comment => `<b>${comment.user}</b>
                                                ...
                                                <div id="comment-$comment-${comment.id}" value="${comment.user}" style="width: 100%; margin-bottom: 10px;" onclick="toggleCommentEdit(event)" >
                                                    ...
                                                    <div style="display: none;">
                                                        ...
                                                        onclick="editComment(event)" class="btn btn-primary" data-bs-dismiss="modal" style="background-color:  #7689b1; border-color: #7689b1;">Update</button>
